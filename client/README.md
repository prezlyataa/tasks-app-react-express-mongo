...
Now you can rename `src/AppComponent.css` to `src/AppComponent.scss` and update `src/AppComponent.component.js` to import `src/AppComponent.scss`.
...
Import required reactstrap components within `src/AppComponent.component.js` file or your custom component files:

```js
import { Button } from 'reactstrap';
```

Now you are ready to use the imported reactstrap components within your component hierarchy defined in the render method. Here is an example [`app.component.jsponent.js`](https://gist.githubusercontent.com/zx6658/d9f128cd57ca69e583ea2b5fea074238/raw/a56701c142d0c622eb6c20a457fbc01d708cb485/AppComponent.component.js) redone using reactstrap.
...
4. Add `// @flow` to any files you want to type check (for example, to `src/AppComponent.component.js`).
...
We recommend to put the test files (or `__tests__` folders) next to the code they are testing so that relative imports appear shorter. For example, if `AppComponent.test.js` and `AppComponent.component.js` are in the same folder, the test just needs to `import AppComponent from './AppComponent'` instead of a long relative path. Colocation also helps find tests more quickly in larger projects.
